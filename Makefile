...
# Driver objects
VAN_OBJECTS		= van_driver.o rtable.o fancy_display.o state.o tcp.o tcpstate.o statefunc.o socktable.o cbuffer.o seq.o
IP_OBJECTS		= ip_driver.o rtable.o fancy_display.o state.o tcp.o tcpstate.o statefunc.o socktable.o cbuffer.o seq.o
